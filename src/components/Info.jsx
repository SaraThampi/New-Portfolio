...
export default function Info() {
    return(
        <div className="info-wrapper"> 
            <p>
                Hi, My name is Sara Thampi and I have just completed an intensive coding bootcamp with School of Code, learning <strong>JavaScript, React</strong> and <strong>Node.js.</strong>
            </p>
            <p>
            ...
            <p>
                So I studied Maths, Physics and German instead. I was fascinated with different cultures and ways of seeing the world, so I decided to study a languages degree (German and Danish) at Edinburgh University; I loved the written work, but found the oral work challenging.
            </p>
            ...
            <p>
                I left retail and became a homeless shelter support worker. I helped the residents apply for benefits and housing and get health support. I realised many of them struggled with computers and really needed my help. I came to the sad realisation, that without help, many of them are denied access to the support available to them. This reminded me of how much I wanted to work in tech. So I googled how I could train as a computer programmer. I was one of 90 people selected for the School of Code bootcamp from over 1000 applicants. I totally loved learning to code in teams and haven&apos;t looked back since.
            </p>
            <p>
