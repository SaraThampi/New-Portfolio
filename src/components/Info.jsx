...
export default function Info() {
    return(
        <div className="info-wrapper"> 
            ...
            <p>
                I left retail and became a homeless shelter support worker. I helped the residents apply for benefits and housing and get health support. I realised many of them struggled with computers and needed my help. I came to the sad realisation, that without help, many of them are denied access to the support available to them. They were also forced to rely on the help of others instead of learning to be self-sufficient. This reminded me of how much I wanted to work in tech. So I googled how I could train as a computer programmer. I was one of 90 people selected for the School of Code bootcamp from over 1000 applicants. I totally loved learning to code in teams and haven&apos;t looked back since.
            </p>
            <p>
